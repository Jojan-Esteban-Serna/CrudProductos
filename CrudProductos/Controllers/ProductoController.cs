...
namespace CrudProductos.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public ProductoController(CrudProductosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Producto != null ? 
                          ...
                          Problem("Entity set 'CrudProductosContext.Producto'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CrudProductosContext.Producto'  is null.");
            }
            var producto = await _context.Producto.FindAsync(id);
            if (producto != null)
            {
